...
class TestEmptyForBlockError(BaseTest):
    ...
    """
        ...
        for_node = ForNode(target_list=target_list,
...
class TestAssignSlice(BaseTest):
    ...
    """
        ...
        assign_node = AssignNode(
            SliceNode(
                LiteralNode(1), LiteralNode(1)), LiteralNode(1))
...
class TestSanitizedFunction(BaseTest):
    ...
    """
        ...
        self.assertEqual(foo_call.sanitization_state, SanitizedState.SANITIZED)
    ...
    """
        ...
        self.assertEqual(foo_call.sanitization_state, SanitizedState.UNKNOWN)
...
class TestNoRaw(BaseTest):
    ...
    def setUp(self):
        self.options = sptoptions.default_options
        self.options.update(enable_warnings=True,
                            warnings_as_errors=True,
                            no_raw=True)
        self.compiler = sptcompiler.Compiler(analyzer_options=self.options,
                                             xspt_mode=False,
