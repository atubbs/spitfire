...
setup(name="spitfire",
      ...
      ext_modules=[Extension("spitfire.runtime._baked", [os.path.join(
          "spitfire", "runtime", "_baked.c")]),
                   Extension("spitfire.runtime._template", [os.path.join(
                       "spitfire", "runtime", "_template.c")]),
                   Extension("spitfire.runtime._udn", [os.path.join(
